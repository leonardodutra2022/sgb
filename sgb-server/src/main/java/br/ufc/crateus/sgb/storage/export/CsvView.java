...
import br.ufc.crateus.sgb.storage.export.abs.AbstractCsvView;
...
/**
 * Classe dedicada a gerar arquivo para exportação em formato CSV
 * @author Leonardo Dutra
 * @see AbstractCsvView
 */
public class CsvView extends AbstractCsvView implements IClass{
	...
	/**
	 * Método responsável por configurar e exportar em CSV tabulado
